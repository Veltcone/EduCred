...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-list">
            ...
            <li>
                <a href="teacher_score.php">
                    <i class="fa-solid fa-book"></i>
                    <span class="link_name">Exam & Test Marks</span>
                </a>
                <span class="tooltip">Exam & Test Marks</span>
            </li>
            <li>
                <a href="teacher_other.php">

                    <i class="fa-regular fa-star"></i>
                    <span class="link_name">Extras</span>
                </a>
                <span class="tooltip">Extras</span>
            </li>
            <li>
                <a href="teacher_chart.php">
                    <i class="bx bx-pie-chart-alt-2"></i>
                    <span class="link_name">Credits</span>
                </a>
